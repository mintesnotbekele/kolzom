...
/** admin/jqadm/type/price/property/fields
 ...
 * @since 2017.10
 */
$default = ['price.property.type.domain', 'price.property.type.status', 'price.property.type.code', 'price.property.type.label'];
$default = $this->config( 'admin/jqadm/type/price/property/fields', $default );
$fields = $this->session( 'aimeos/admin/jqadm/type/price/property/fields', $default );
...
$columnList = [
	'price.property.type.id' => $this->translate( 'admin', 'ID' ),
	'price.property.type.domain' => $this->translate( 'admin', 'Domain' ),
	'price.property.type.status' => $this->translate( 'admin', 'Status' ),
	'price.property.type.code' => $this->translate( 'admin', 'Code' ),
	'price.property.type.label' => $this->translate( 'admin', 'Label' ),
	'price.property.type.position' => $this->translate( 'admin', 'Position' ),
	'price.property.type.ctime' => $this->translate( 'admin', 'Created' ),
	'price.property.type.mtime' => $this->translate( 'admin', 'Modified' ),
	'price.property.type.editor' => $this->translate( 'admin', 'Editor' ),
];
...
<div class="list-view"
	...
	data-filter="<?= $enc->attr( $this->session( 'aimeos/admin/jqadm/type/price/property/filter', new \stdClass ) ) ?>"
	data-items="<?= $enc->attr( $this->get( 'items', map() )->call( 'toArray', [true] )->all() ) ?>">

	<nav class="main-navbar">

		<span class="navbar-brand">
			<?= $enc->html( $this->translate( 'admin', 'Price Property Types' ) ) ?>
	...
	<nav-search v-bind:show="search" v-on:close="search = false"
		...
		v-bind:filter="<?= $enc->attr( (object) $this->session( 'aimeos/admin/jqadm/type/price/property/filter', new \stdClass ) ) ?>"
	...
	<?= $this->partial(
			...
			'page' => $this->session( 'aimeos/admin/jqadm/type/price/property/page', [] )]
		);
	?>

	<form ref="form" class="list list-price-property-type" method="POST"
				...
				<thead class="list-header">
					<tr>
						...
						<?= $this->partial(
								...
								['fields' => $fields, 'params' => $params, 'data' => $columnList, 'sort' => $this->session( 'aimeos/admin/jqadm/type/price/property/sort' )]
							);
						?>
				...
				<tbody>
					...
					<?= $this->partial(
						$this->config( 'admin/jqadm/partial/listsearch', 'listsearch' ), [
							'fields' => array_merge( $fields, ['select'] ), 'filter' => $this->session( 'aimeos/admin/jqadm/type/price/property/filter', [] ),
							'data' => [
								'price.property.type.id' => ['op' => '=='],
								'price.property.type.domain' => ['op' => '==', 'type' => 'select', 'val' => $domains],
								'price.property.type.status' => ['op' => '==', 'type' => 'select', 'val' => [
									'1' => $this->translate( 'mshop/code', 'status:1' ),
									'0' => $this->translate( 'mshop/code', 'status:0' ),
									'-1' => $this->translate( 'mshop/code', 'status:-1' ),
									'-2' => $this->translate( 'mshop/code', 'status:-2' ),
								]],
								'price.property.type.code' => [],
								'price.property.type.label' => [],
								'price.property.type.position' => ['op' => '>=', 'type' => 'number'],
								'price.property.type.ctime' => ['op' => '-', 'type' => 'datetime-local'],
								'price.property.type.mtime' => ['op' => '-', 'type' => 'datetime-local'],
								'price.property.type.editor' => [],
							]
						] );
					?>
						...
						<td colspan="<?= count( $fields ) + 2 ?>">
							...
							<div class="card">
								<div class="card-header">
									...
									<button class="btn btn-primary" formaction="<?= $enc->attr( $this->link( 'admin/jqadm/url/batch', ['resource' => 'type/price/property'] ) ) ?>">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-lg-6">
											<div class="row">
												<div class="col-1">
													<input id="batch-price-property-type-status" class="form-check-input" type="checkbox" v-on:click="setState('item/price.property.type.status')">
												</div>
												<label class="col-4 form-control-label" for="batch-price-property-type-status">
													<?= $enc->html( $this->translate( 'admin', 'Status' ) ) ?>
												</label>
												<div class="col-7">
													<select class="form-select" v-bind:disabled="state('item/price.property.type.status')"
														name="<?= $enc->attr( $this->formparam( array( 'item', 'price.property.type.status' ) ) ) ?>">
														<option value=""></option>
											...
											<div class="row">
												<div class="col-1">
													<input id="batch-price-property-type-domain" class="form-check-input" type="checkbox" v-on:click="setState('item/price.property.type.domain')">
												</div>
												<label class="col-4 form-control-label" for="batch-price-property-type-domain">
													<?= $enc->html( $this->translate( 'admin', 'Domain' ) ) ?>
												</label>
												<div class="col-7">
													<select class="form-select" v-bind:disabled="state('item/price.property.type.domain')"
														name="<?= $enc->attr( $this->formparam( array( 'item', 'price.property.type.domain' ) ) ) ?>">
														<option value=""></option>
											...
											<div class="row">
												<div class="col-1">
													<input id="batch-price-property-type-position" class="form-check-input" type="checkbox" v-on:click="setState('item/price.property.type.position')">
												</div>
												<label class="col-4 form-control-label" for="batch-price-property-type-position">
													<?= $enc->html( $this->translate( 'admin', 'Position' ) ) ?>
												</label>
												<div class="col-7">
													<input class="form-control" type="number" v-bind:disabled="state('item/price.property.type.position')"
														name="<?= $enc->attr( $this->formparam( array( 'item', 'price.property.type.position' ) ) ) ?>">
												</div>
											</div>
										</div>
										<div class="col-lg-6">
