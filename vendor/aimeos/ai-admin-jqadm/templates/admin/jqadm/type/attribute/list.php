...
<div class="list-view"
	...
	data-filter="<?= $enc->attr( $this->session( 'aimeos/admin/jqadm/type/attribute/filter', new \stdClass ) ) ?>"
	...
	<nav-search v-bind:show="search" v-on:close="search = false"
		...
		v-bind:filter="<?= $enc->attr( (object) $this->session( 'aimeos/admin/jqadm/type/attribute/filter', new \stdClass ) ) ?>"
	...
	<form ref="form" class="list list-attribute-type" method="POST"
					...
					<?= $this->partial(
						$this->config( 'admin/jqadm/partial/listsearch', 'listsearch' ), [
							...
							'data' => [
								...
								'attribute.type.domain' => ['op' => '==', 'type' => 'select', 'val' => $domains],
						...
						<td colspan="<?= count( $fields ) + 2 ?>">
							...
							<div class="card">
								<div class="card-header">
									...
									<button class="btn btn-primary" formaction="<?= $enc->attr( $this->link( 'admin/jqadm/url/batch', ['resource' => 'type/attribute'] ) ) ?>">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-lg-6">
											<div class="row">
												<div class="col-1">
													<input id="batch-attribute-type-status" class="form-check-input" type="checkbox" v-on:click="setState('item/attribute.type.status')">
												</div>
												<label class="col-4 form-control-label" for="batch-attribute-type-status">
													<?= $enc->html( $this->translate( 'admin', 'Status' ) ) ?>
												</label>
												<div class="col-7">
													<select class="form-select" v-bind:disabled="state('item/attribute.type.status')"
														name="<?= $enc->attr( $this->formparam( array( 'item', 'attribute.type.status' ) ) ) ?>">
														<option value=""></option>
											...
											<div class="row">
												<div class="col-1">
													<input id="batch-attribute-type-domain" class="form-check-input" type="checkbox" v-on:click="setState('item/attribute.type.domain')">
												</div>
												<label class="col-4 form-control-label" for="batch-attribute-type-domain">
													<?= $enc->html( $this->translate( 'admin', 'Domain' ) ) ?>
												</label>
												<div class="col-7">
													<select class="form-select" v-bind:disabled="state('item/attribute.type.domain')"
														name="<?= $enc->attr( $this->formparam( array( 'item', 'attribute.type.domain' ) ) ) ?>">
														<option value=""></option>
											...
											<div class="row">
												<div class="col-1">
													<input id="batch-attribute-type-position" class="form-check-input" type="checkbox" v-on:click="setState('item/attribute.type.position')">
												</div>
												<label class="col-4 form-control-label" for="batch-attribute-type-position">
													<?= $enc->html( $this->translate( 'admin', 'Position' ) ) ?>
												</label>
												<div class="col-7">
													<input class="form-control" type="number" v-bind:disabled="state('item/attribute.type.position')"
														name="<?= $enc->attr( $this->formparam( array( 'item', 'attribute.type.position' ) ) ) ?>">
												</div>
											</div>
										</div>
										<div class="col-lg-6">
